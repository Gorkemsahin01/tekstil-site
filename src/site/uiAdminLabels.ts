...
export const UI_ADMIN_LABELS: Record<keyof UiStrings, string> = {
  ...
  contactPhone: 'İletişim formu: Telefon etiketi',
  ...
  contactPlaceholderPhone: 'İletişim formu: Telefon placeholder',
  contactJobTitle: 'İletişim formu: Görev / unvan etiketi',
  contactPlaceholderJobTitle: 'İletişim formu: Görev seçimi placeholder',
  ...
  akademiBackToList: 'Yazı: Academify’a dön',
