...
export const UI_ADMIN_LABELS: Record<keyof UiStrings, string> = {
  ...
  waitlistSentTitle: 'Toast: bekleme listesi başarı başlığı',
  waitlistSentApi: 'Toast: API ile gönderildi açıklaması',
  waitlistSentMailto: 'Toast: mailto ile açıldı açıklaması',
