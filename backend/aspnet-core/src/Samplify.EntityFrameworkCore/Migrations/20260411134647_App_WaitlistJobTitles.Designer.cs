...
{
    [DbContext(typeof(SamplifyDbContext))]
    [Migration("20260411134647_App_WaitlistJobTitles")]
    partial class App_WaitlistJobTitles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Samplify.BlogPosts.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("BodyEnJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("BodyTrJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ReadMinutesEn")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ReadMinutesTr")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Samplify.SiteContents.SiteContentSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSiteContentSnapshots", (string)null);
                });

            modelBuilder.Entity("Samplify.Waitlist.WaitlistJobTitle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWaitlistJobTitles", (string)null);
                });
