        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryTr = table.Column<string>(type: "text", nullable: false),
                    CategoryEn = table.Column<string>(type: "text", nullable: false),
                    TitleTr = table.Column<string>(type: "text", nullable: false),
                    TitleEn = table.Column<string>(type: "text", nullable: false),
                    ExcerptTr = table.Column<string>(type: "text", nullable: false),
                    ExcerptEn = table.Column<string>(type: "text", nullable: false),
                    ReadMinutesTr = table.Column<string>(type: "text", nullable: false),
                    ReadMinutesEn = table.Column<string>(type: "text", nullable: false),
                    BodyTrJson = table.Column<string>(type: "text", nullable: false),
                    BodyEnJson = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSiteContentSnapshots", x => x.Id);
                });
