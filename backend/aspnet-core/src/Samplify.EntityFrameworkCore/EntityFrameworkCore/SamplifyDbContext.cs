...
public class SamplifyDbContext :
    AbpDbContext<SamplifyDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public SamplifyDbContext(DbContextOptions<SamplifyDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<SiteContentSnapshot>(b =>
        {
            b.ToTable(SamplifyConsts.DbTablePrefix + "SiteContentSnapshots", SamplifyConsts.DbSchema);
        ...
        {
            b.ToTable(SamplifyConsts.DbTablePrefix + "BlogPosts", SamplifyConsts.DbSchema);
            b.ConfigureByConvention();
